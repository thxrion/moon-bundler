...
lua_module_t lua_module_duplicate(const lua_module_t);
bool lua_module_check_if_valid(const lua_module_t);
void lua_module_free(lua_module_t);
void lua_module_print(const lua_module_t);
